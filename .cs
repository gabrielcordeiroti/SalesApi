...
using Xunit;
using MyTestSalesApi.Domain.Entities;
using MyTestSalesApi.Domain.Services;
...
namespace MyTest.Tests
{
    ...
    public class SaleServiceTests
    {
        ...
        {
            // Arrange
            var sale = new MyTestSalesApi.Domain.Entities.Sale
            {
                Items = new List<MyTestSalesApi.Domain.Entities.SaleItem>
                {
                    new MyTestSalesApi.Domain.Entities.SaleItem { ProductId = Guid.NewGuid(), Quantity = quantity, UnitPrice = 100 }
                }
            };
            var service = new MyTestSalesApi.Domain.Services.SaleService();
        ...
        public void ApplyDiscounts_ThrowsWhenQuantityAbove20()
        {
            ...
            var sale = new MyTestSalesApi.Domain.Entities.Sale
            {
                Items = new List<MyTestSalesApi.Domain.Entities.SaleItem>
                {
                    new MyTestSalesApi.Domain.Entities.SaleItem { ProductId = Guid.NewGuid(), Quantity = 21, UnitPrice = 100 }
                }
            };
            var service = new MyTestSalesApi.Domain.Services.SaleService();
